      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <Section title="1. Aceitação dos termos">
          ...
          <p className="mt-2">
            ...
            <strong>Redirect Grupo Tecnologia Ltda.</strong> ("Redirect Grupo", "nós" ou "Empresa").
          </p>
        </Section>
        ...
        <Section title="11. Lei aplicável e foro">
          ...
          <p className="mt-2">
            ...
            <a href="mailto:suporte@redirectgrupo.com.br" className="text-brand-600 hover:underline">
