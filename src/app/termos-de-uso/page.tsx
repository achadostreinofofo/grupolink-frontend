...
export const metadata = {
  title: 'Termos de Uso – GrupoLink',
  description: 'Termos e condições para uso da plataforma GrupoLink.',
}
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <Section title="1. Aceitação dos termos">
          <p>
            Ao criar uma conta ou utilizar a plataforma <strong>GrupoLink</strong>, você declara que leu,
        ...
        <Section title="2. Descrição do serviço">
          <p>
            O GrupoLink é uma plataforma SaaS que permite a afiliados e vendedores de e-commerce:
          </p>
        ...
        <Section title="3. Cadastro e responsabilidades da conta">
          <p>Para utilizar o GrupoLink você deve:</p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>Notificar imediatamente o GrupoLink em caso de acesso não autorizado à sua conta.</li>
          </ul>
          <p className="mt-3">
            Você é integralmente responsável por todas as atividades realizadas na sua conta. O GrupoLink
            não se responsabiliza por perdas decorrentes do uso indevido das suas credenciais.
          </p>
        </Section>

        <Section title="4. Planos e pagamentos">
          <p>O GrupoLink oferece os seguintes planos:</p>
        ...
        <Section title="5. Uso permitido e proibido">
          ...
          <ul className="list-disc pl-5 mt-1 space-y-1">
            <li>Usar o GrupoLink para envio de spam, mensagens fraudulentas ou conteúdo ilegal;</li>
            ...
            <li>Realizar engenharia reversa, descompilar ou tentar extrair o código-fonte do GrupoLink;</li>
        ...
        <Section title="6. Integração com o WhatsApp">
          <p>
            O GrupoLink utiliza a <strong>WhatsApp Cloud API oficial da Meta</strong>. Ao conectar sua conta
            WhatsApp Business à plataforma, você concorda que:
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>É responsável por cumprir as <a href="https://business.whatsapp.com/policy" target="_blank" rel="noopener noreferrer" className="text-brand-600 hover:underline">Políticas Comerciais do WhatsApp</a>;</li>
            <li>O envio de mensagens em massa deve respeitar os limites e diretrizes da Meta;</li>
            <li>O GrupoLink não se responsabiliza por suspensões de números ou contas WhatsApp Business impostas pela Meta por violação das políticas daquela plataforma;</li>
            <li>Você é o controlador dos dados dos membros dos seus grupos; o GrupoLink atua como operador de dados nessa relação.</li>
          </ul>
        </Section>

        <Section title="7. Propriedade intelectual">
          <p>
            Todo o conteúdo da plataforma GrupoLink — incluindo marca, logotipo, interface, código-fonte
            e documentação — é de propriedade exclusiva da GrupoLink Tecnologia Ltda. e protegido pela
        ...
        <Section title="9. Limitação de responsabilidade">
          <p>
            O GrupoLink não se responsabiliza por:
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
        ...
        <Section title="10. Rescisão">
          <p>
            O GrupoLink pode suspender ou encerrar sua conta, com ou sem aviso prévio, nos seguintes casos:
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <p className="mt-3">
            ...
            <a href="/politica-de-privacidade" className="text-brand-600 hover:underline">
        ...
        <Section title="11. Lei aplicável e foro">
          ...
          <p className="mt-2">
            ...
            <a href="mailto:suporte@grupolink.com.br" className="text-brand-600 hover:underline">
              suporte@grupolink.com.br
            </a>
            .
          </p>
        </Section>
