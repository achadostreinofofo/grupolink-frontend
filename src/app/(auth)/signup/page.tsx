...
function CpfConflictModal({ onLogin, onTryAgain }: { onLogin: () => void; onTryAgain: () => void }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 flex flex-col gap-4">
        ...
        <div className="text-center">
          <h2 className="text-lg font-bold text-gray-900">CPF já cadastrado</h2>
          <p className="text-sm text-gray-500 mt-1">
            Já existe uma conta vinculada a este CPF. O que deseja fazer?
          </p>
        </div>
...
export default function SignupPage() {
  ...
  return (
    <>
      {showCpfConflict && (
        <CpfConflictModal onLogin={handleLogin} onTryAgain={handleTryAgain} />
      )}
